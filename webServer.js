        ...
        if (exists) {
            ...
            fs.readFile(filePath, function (error, content) {
                ...
                if (error) {
                    ...
                    response.end(content.toString('utf-8'), 'utf-8');
                }
                redirectLoop = 0;
            });
...
exports.start = function (ip, port) {
    ...
    server.listen(8080, '192.168.1.17');
    
    if(ip) {
        console.log(magenta + 'SSServer running at: ' + reset + 'http://' + IP + ':' + PORT + '/');
    }else{
        console.log(magenta + 'SSServer running at: ' + reset + 'http://localhost:' + PORT + '/');
    }
